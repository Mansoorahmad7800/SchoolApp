...
class ClassTwelve extends StatefulWidget {
  ...
  ClassTwelve(this.colorval);
  int colorval;

  State<ClassTwelve> createState() => _ClassTwelveState();
}

class _ClassTwelveState extends State<ClassTwelve> with SingleTickerProviderStateMixin {
